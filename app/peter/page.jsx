      ...
      <main className="flex">
        ...
        <div className="flex-1 flex items-center justify-center bg-white p-10">
          <div className="text-center">
            <h1 className="text-2xl font-bold text-gray-800 mb-4">Build something exciting with Shutterstock</h1>
            <p className="text-gray-600 mb-6">
              Enhance your applications using our API, Editor SDK, and more.
              For more information, see our{' '}
              <a href="#" className="text-blue-600 hover:underline">Developer Portal</a>,{' '}
              <a href="#" className="text-blue-600 hover:underline">API documentation</a>, or{' '}
              <a href="#" className="text-blue-600 hover:underline">Plans and Pricing</a>
            </p>
